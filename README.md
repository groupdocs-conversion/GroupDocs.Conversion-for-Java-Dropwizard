...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-conversion/GroupDocs.Conversion-for-Java-Dropwizard/releases/download/0.0.5/release.tar.gz
tar -xvzf release.tar.gz
cd release
java -jar conversion-dropwizard-0.0.5.jar configuration.yaml
## Open http://localhost:8080/conversion/ in your favorite browser.
```
